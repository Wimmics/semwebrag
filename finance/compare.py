...
def evaluate_metrics(question, true_answer):
    ...
    # try:
    #     result = subprocess.run([venv_python, '-m', 'finance.userPrompt', question], 
    #                              capture_output=True, 
    #                              text=True, 
    #                              check=True)  
    ...
    try:
        ...
        pa = subprocess.run([venv_python, '-m', 'finance.prompt3', question], capture_output=True, text=True, check=True)
...
evaluate_metrics( argv[1], argv[2])
